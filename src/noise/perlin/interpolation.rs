    ...
    pub(super) fn compute_noise_from_vecs_2d<const INITIALIZE: bool>(
        ...
        for y_it in (0..ROW_SIZE).step_by(f32::LANES * NUM_BLOCKS) {
            ...
            for block in 0..NUM_BLOCKS {
                ...
                // Base interpolation.
                base_lerps_top[block] = y_lerp.mul_add(prod_sum_tr - prod_sum_tl, prod_sum_tl) * weight_vec;
            ...
            while x_it < x_end_index {
                if x_it + 4 > x_end_index {
                    ...
                    for block in 0..NUM_BLOCKS {
                        let index: usize = x_it * ROW_SIZE + y_it + block * f32::LANES + ROW_SIZE * 2;
                    ...
                    for block in 0..NUM_BLOCKS {
                        let index: usize = x_it * ROW_SIZE + y_it + block * f32::LANES + ROW_SIZE * 3;
            ...
            for z_it in (0..ROW_SIZE).step_by(f32::LANES * NUM_BLOCKS) {
                ...
                while y_it < y_end_index {
                    ...
                    if y_it + 4 <= y_end_index {
                        ...
                        for block in 0..NUM_BLOCKS {
                            let index: usize = x_it * MAP_SIZE + y_it * ROW_SIZE + z_it + block * f32::LANES + ROW_SIZE;
                        ...
                        for block in 0..NUM_BLOCKS {
                            let index: usize = x_it * MAP_SIZE + y_it * ROW_SIZE + z_it + block * f32::LANES + ROW_SIZE * 2;
                        ...
                        for block in 0..NUM_BLOCKS {
                            let index: usize = x_it * MAP_SIZE + y_it * ROW_SIZE + z_it + block * f32::LANES + ROW_SIZE * 3;
