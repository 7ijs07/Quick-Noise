    ...
    //     fn splat_64<T>(val: T) -> Self { self_from_op_copy!(_mm512_set1_epi64, val) }
    //     fn splat_32<T>(val: T) -> Self { self_from_op_copy!(_mm512_set1_epi32, val) }
    //     fn splat_16<T>(val: T) -> Self { self_from_op_copy!(_mm512_set1_epi16, val) }
    //     fn splat_8<T>(val: T) -> Self { self_from_op_copy!(_mm512_set1_epi8, val) }
    // }
